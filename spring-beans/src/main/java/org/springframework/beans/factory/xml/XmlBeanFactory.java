...
/**
 * XmlBeanFactory对DefaultListableBeanFactory类进行了扩展,主要是用于从XML文档中读取BeanDefinition，对于注册以及获取bean都是从
 * 父类DefaultListableBeanFactory继承的方法去实现,而唯独与父类不同的个性化实现就是增加了XmlBeanDefinitionReader类型的reader属性
